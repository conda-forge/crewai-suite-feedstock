About crewai-suite-feedstock
============================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/crewai-suite-feedstock/blob/main/LICENSE.txt)
...
Summary: CrewAI framework and tools for orchestrating autonomous AI agents
      ...
      <details>
        <summary>
          <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=28335&branchName=main">
            <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/crewai-suite-feedstock?branchName=main">
          </a>
        </summary>
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=28335&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/crewai-suite-feedstock?branchName=main&jobName=win&configuration=win%20win_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
Installing crewai-suite
=======================

Installing `crewai-suite` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
```
conda search crewai --channel conda-forge
```

or with `mamba`:

```
mamba search crewai --channel conda-forge
```
...
mamba repoquery search crewai --channel conda-forge

# List packages depending on `crewai`:
mamba repoquery whoneeds crewai --channel conda-forge

# List dependencies of `crewai`:
mamba repoquery depends crewai --channel conda-forge
```
...
Updating crewai-suite-feedstock
===============================

If you would like to improve the crewai-suite recipe or build a new
...
Note that all branches in the conda-forge/crewai-suite-feedstock are
